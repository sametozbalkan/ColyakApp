...
class HttpBuildService {
  ...
  static Future<void> saveTokensToPrefs(
    ...
    if (storedEmail != null) await prefs.setString('storedEmail', storedEmail);
    if (storedPassword != null) {
      await prefs.setString('storedPassword', storedPassword);
    }
    if (isChecked != null) await prefs.setBool('isChecked', isChecked);
  }
  ...
  static Future<bool?> getStoredBool(String key) async {
    final prefs = await SharedPreferences.getInstance();
