...
class InfoScreen extends StatelessWidget {
  ...
  static const List<PageData> pages = [
    PageData(
      ...
      description: "Uygulamaya giriş yaptığınızda sizi karşılayan ilk ekran.",
      imageAsset: "assets/images/mainscreen.png",
    ),
    PageData(
      title: "Kolay Erişilebilir Menü",
      description:
          "Ana ekranın sol üst köşesinden menüye kolayca erişebilir ve yapmak istediklerinizi seçebilirsiniz.",
      imageAsset: "assets/images/hamburger.png",
    ),
    PageData(
      title: "Öğün Listeni Oluştur",
      description:
          "Öğün listeni oluşturarak bolus için karbonhidrat değerini kolayca belirleyebilirsin.",
      imageAsset: "assets/images/mealscreen.png",
    ),
    PageData(
      title: "Yüzlerce Tarif ve Gıda",
      description:
          "Bu listeden istediğin tarifi ve hazır gıdayı seçebilirsin ve kolayca listene ekleyebilirsin.",
      imageAsset: "assets/images/addmealscreen.png",
    ),
    PageData(
      title: "Çeşit Çeşit Tarifler",
      description:
          "Diyetisyeninin özenle hazırladığı tariflere kolayca erişebilirsin ve favorilerine ekleyebilirsin.",
      imageAsset: "assets/images/receipts.png",
    ),
    PageData(
      title: "Geniş Tarif Detayları",
      description:
          "İstediğin tarifin malzemelerine, yapılışına ve besin değerlerine kolayca ulaşabilirsin.",
      imageAsset: "assets/images/receiptdetails.png",
    ),
    PageData(
      title: "Tariflere Yorum Yap",
      description:
          "İstediğin tarifin altına bu tarifle ilgili aklından ne geçerse yazabilirsin.",
      imageAsset: "assets/images/commentscreen.png",
    ),
    PageData(
      title: "Yanıtlarda Tartış",
      description:
          "İstediğin yoruma tıklayarak cevap yazabilir ve yorum sahibiyle tarif hakkında konuşabilirsin.",
      imageAsset: "assets/images/replyscreen.png",
    ),
    PageData(
      title: "Bolus Hesaplayıcı",
      description:
          "Öğün listeni oluşturduktan sonra gerekli alanları doldurup alman gereken insülini buradan hesapla.",
      imageAsset: "assets/images/bolus.png",
    ),
    PageData(
      title: "Bolus Raporların",
      description:
          "Dilediğin tarih aralığındaki bolus raporlarını inceleyebilirsin.",
    ...
    PageData(
      ...
      description:
          "Birbirinden farklı eğitici ve öğretici quizleri çözüp bilgilerini test edebilirsin.",
